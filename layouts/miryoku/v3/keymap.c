...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [NAV] = LAYOUT_60_ansi(
        TD(TD_BOOT), TD(TD_NAV),  TD(TD_GAME), TD(TD_BASE), U_NA, U_NP, U_NP, U_NP, U_RDO,   U_PST,   U_CPY,   U_CUT,  U_UND,    U_NP,
    ...
    [MOUSE] = LAYOUT_60_ansi(
        ...
        U_NA,        KC_ALGR,     TD(TD_SYM),  TD(TD_MOUSE),U_NA,    U_NP, U_NP, U_NP, U_NA,         MS_WHLL, MS_WHLD, MS_WHLU,          MS_WHLR,
        U_NP,        U_NA,        U_NA,        U_NA,        U_NP,    U_NP, U_NP, U_NP, MS_BTN2,      MS_BTN1, MS_BTN3,                   U_NP,
        U_NP, U_NP,  U_NP,                                                       U_NP,                                    U_NP,    U_NP,    U_NP,    U_NP
    ),

    [MEDIA] = LAYOUT_60_ansi(
        TD(TD_BOOT), TD(TD_NAV),  TD(TD_GAME), TD(TD_BASE), U_NA,    U_NP, U_NP, U_NP, UG_TOGG, U_NU,    U_NU,    U_NU,    U_NU,    U_NP,
    ...
    [GAME] = LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                         KC_SPC,                                KC_F4, KC_F1, KC_F2, KC_F3
    )
};
// clang-format on
///////////////////////////////////////////////////////////////////////////////
...
const uint16_t PROGMEM thumbcombos_base_G_r[]   = {KC_EQL, KC_BSPC, COMBO_END};
...
// clang-format off
combo_t key_combos[] = {
    [CB_KCEQL_KCBSPC_BASE] = COMBO_ACTION(thumbcombos_base_G_r),
