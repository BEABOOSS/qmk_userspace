...
#define KEYCODE_STRING_NAMES_USER(...)                                                                                                     \
    ...
    uint16_t                           keycode_string_names_size_user = sizeof(keycode_string_names_user) / sizeof(keycode_string_name_t); \
    const keycode_string_name_t*       keycode_string_names_data_user = keycode_string_names_user
